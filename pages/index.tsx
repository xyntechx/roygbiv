...
const Home: NextPage = () => {
    return (
        <main className="flex min-h-screen flex-col items-center justify-center py-2">
            ...
            <Link href="/help">
                <a className="border-2 border-blue-400 rounded-full py-3 px-5 text-center text-blue-600 text-lg hover:bg-blue-400 hover:text-black transition-colors fixed bottom-10 right-10 font-bold animate-bounce">
                    ?
                </a>
            </Link>
        </main>
